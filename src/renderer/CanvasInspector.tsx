  ...
  useEffect(() => {
    const listener = (event: MessageEvent): void => {
      ...
      if (payload.type === "console" && typeof payload.message === "string") {
        setConsoleEntries((current) => [...current, {
          level: typeof payload.level === "string" ? payload.level : "log",
          message: payload.message.slice(0, 12_000),
