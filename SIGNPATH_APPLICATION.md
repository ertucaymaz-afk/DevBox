...
- Public release: https://github.com/ertucaymaz-afk/DevBox/releases/tag/v0.1.0
...
- Public release and documented download/uninstall path: `README.md` and the `v0.1.0` GitHub release
