...
Bu dizin, GitHub depo kökünü kompakt tutarken ürün ve yayın belgelerine tek yerden erişim sağlar.
...
- [SignPath Foundation başvuru kaydı](signing/SIGNPATH_APPLICATION.md)

SignPath başvurusu dış incelemededir. Güvenilir yayın sertifikası sağlanmadan bir dosya imzalı veya doğrulanmış yayın olarak tanımlanmaz.
