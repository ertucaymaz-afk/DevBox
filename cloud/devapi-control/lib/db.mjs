...
export async function listProjects(limit = 100) {
  ...
  return await query.query(
    `SELECT
      ...
      latest_snapshot->'product'->>'name' AS "productName",
      latest_snapshot->'product'->>'version' AS "productVersion",
      latest_snapshot->'product'->>'cloudProtocol' AS "cloudProtocol",
      latest_snapshot->'evolution'->>'enabled' AS "evolutionEnabled",
      latest_snapshot->'evolution'->>'isRunning' AS "evolutionRunning",
