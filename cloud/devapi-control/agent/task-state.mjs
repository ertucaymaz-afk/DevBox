const ACTIVE = [
  ...
  "PREVIEWING", "PREVIEW_VERIFIED", "CANARYING", "CANARY_VERIFIED",
  "PRODUCTION_PROMOTING", "PRODUCTION_VERIFIED", "PROMOTING", "OBSERVING", "KNOWN_GOOD", "COMPLETED"
];
...
const NEXT = new Map([
  ...
  ["CANARY_VERIFIED", new Set(["PRODUCTION_PROMOTING", "PROMOTING", "COMPLETED", "ROLLED_BACK", "CANCELLED"])],
  ["PRODUCTION_PROMOTING", new Set(["PRODUCTION_VERIFIED", "ROLLED_BACK", "FAILED", "BLOCKED_EXTERNAL", "TIMED_OUT"])],
  ["PRODUCTION_VERIFIED", new Set(["OBSERVING", "ROLLED_BACK", "FAILED", "TIMED_OUT"])],
  ["PROMOTING", new Set(["PRODUCTION_VERIFIED", "OBSERVING", "ROLLED_BACK", "FAILED", "BLOCKED_EXTERNAL", "TIMED_OUT"])],
