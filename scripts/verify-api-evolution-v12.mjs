...
if(!new RegExp(`^# DevBox v${String(pkg.version).replaceAll(".","\\.")}$`,`mu`).test(readme))throw new Error("API_EVOLUTION_V12_VERIFY_FAIL:readme-current-version");
forbid(readme,"Güncel işlevsel önizleme **DevBox v0.1.4**","readme-stale-version");
for (const needle of ["300 MiB","ConPTY","SQLite + FTS5","DevAPI Cloud Control"]) need(readme,needle,`readme-${needle}`);
