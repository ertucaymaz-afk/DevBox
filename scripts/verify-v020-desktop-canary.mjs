...
const [pkgRaw, canary, service, db, idempotencyTest, snapshotApi] = await Promise.all([
...
console.log(`V020_DESKTOP_CANARY_VERIFY_PASS version=${version} desktopIdentity=explicit adminOnly=true selfAck=false appliedTimeBound=true idempotencyFaultInjection=true`);
