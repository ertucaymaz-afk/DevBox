...
const [pkgRaw, contracts, service, db, cloudVerify, evidenceRaw, linksRaw, readme, devboxIndex, devapiIndex, research] = await Promise.all([
...
console.log(`API_EVOLUTION_V13_VERIFY_PASS inherited=v12 tracks=expanded canonicalSchema=pass canonicalUrls=evidence-driven productionState=${evidence.release?.productionEvidence??"UNKNOWN"} visuals=3 research=recorded`);
