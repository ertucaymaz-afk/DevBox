...
console.log("DEVAPI_WORKER_SECURITY_PASS approval=verified pathEscape=blocked shellInjection=blocked gitPush=blocked env=minimal outputRedaction=present singleWriter=verified secretLiteralScan=pass");
