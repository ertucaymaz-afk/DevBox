...
const after = `{
  ...
  if (migrationStart < 0 || integrityStart < 0 || integrityStart <= migrationStart) throw new Error("V014_CORE12_DATABASE_SCOPE_INVALID");
  ...
  if (guardAt < 0 || migration.indexOf(guard) !== guardAt) throw new Error("V014_CORE12_DATABASE_FINAL_GUARD_INVALID");
